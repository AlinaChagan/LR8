...
namespace Laba8
{
    //обобщенный тип (класс) CollectionType<T>
    public class List<T> : IGeneric<T>
    {
        ...
        public Owner ListOwner { get; set; }
        ...
        {
            using (StreamWriter sw = new StreamWriter(@"C:\ALINA\Term3\ООП\лабораторные\лаба8\LR8\Data.txt"))
            {
                var temp = Head;
        ...
        {
            using (StreamReader sw = new StreamReader(@"C:\ALINA\Term3\ООП\лабораторные\лаба8\LR8\Data.txt"))
            {
